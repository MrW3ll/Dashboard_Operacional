...
PLOTLY_LAYOUT_VENDAS = dict(
    ...
    yaxis=dict(visible=False, gridcolor='#1a2035'),
    xaxis=dict(
        title=None,
        tickfont=dict(size=14, color="#9699a3", family='DM Sans'),
        ticklen=0, showline=False, zeroline=False,
    ),
    uniformtext=dict(mode='hide', minsize=8),
    hoverlabel=dict(
        bgcolor='#141b2d', bordercolor='#1a2035',
        font=dict(color='#c9d1e8', size=13, family='DM Sans'),
    ),
)
...
PLOTLY_LAYOUT_ATENDIMENTO = dict(
    ...
    xaxis=dict(
        title=None,
        tickfont=dict(size=13, color='#5a6380', family='DM Sans'),
        ticklen=0, showline=False, zeroline=False,
    ),
    legend=dict(
